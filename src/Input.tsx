...
const Input = (props: InputProps) => (
	<textarea
		class={`w-full resize-none border-none bg-transparent py-2 outline-hidden [field-sizing:content] read-only:text-frozen dark:text-white ${props.type === 'title' ? 'text-2xl/[3rem] font-black md:text-4xl/[3rem]' : 'text-base/8 md:text-xl/8'}`}
		{...props}
	/>
);
